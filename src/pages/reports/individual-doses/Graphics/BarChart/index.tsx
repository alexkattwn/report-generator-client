...
import cls from '@/pages/reports/individual-doses/Graphics/BarChart/index.module.scss'
...
interface BarChartIDProps {
    graphic: IGraphic
}

const BarChartID: React.FC<BarChartIDProps> = ({ graphic }) => {
