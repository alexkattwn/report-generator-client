...
const FooterReportIDC: React.FC = () => (
    <View style={styles.main}>
        ...
        <Text style={styles.notes}>
            Примечание - в таблице 2 приведены сводные суммарные индивидуальны
            дозы за календарные годовые и пятилетние периоды. При отсутствии
            данных об индивидуальных дозах за отдельный календарный год или его
            часть, соответствующее значение для вывода в таблице 2 принимается
            равным 0. За текущий календарный год приведены дозы на дату выдачи
            копии карты (см. ниже).
        </Text>
        <View style={styles.block}>
